  ...
  const handleUpdate = () => {
    const postData = async () => {
      try {
        ...
        // console.log(`${API_URL}/Pengeluaran/${data.id}`);
        ...
        <View className="px-2">
          <View className="bg-white p-5 rounded-t-2xl w-full">
            <View className="flex-row justify-between items-center mb-3">
              <Text className="text-xl font-bold">Update Pengeluaran</Text>
...
export default PopupUpdatePengeluaran;
