      ...
      <Modal transparent={true} visible={visible} animationType="slide">
        ...
        <View className="px-6 bg-black/75 ">
          <View className="w-full flex justify-center items-center">
            <View className="bg-[#E3F6F5] rounded-full  p-3  absolute z-20 flex justify-center items-center">
              <Ionicons
          ...
          <View className="bg-white px-5 pb-5 w-full">
            ...
            <View className="flex-row justify-between">
              <View>
                <Text className="text-lg">Kategori Pendapatan</Text>
...
export default PopupPendapatan;
