...
const PopupTambahPendapatan = ({ visible, onClose, updating }) => {
    ...
    const postData = async () => {
      try {
        ...
        const response = await axios.post(
          `${API_URL}/pendapatan`, // Ganti dengan URL API Anda
          data,
          {
            headers: {
        ...
        <View className="bg-black/75 px-2 ">
          <View className="bg-white p-5 rounded-t-2xl w-full">
            <View className="flex-row justify-between items-center mb-3">
              <Text className="text-xl font-bold">Tambah Pendapatan</Text>
...
export default PopupTambahPendapatan;
